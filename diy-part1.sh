...
echo "src-git helloworld https://github.com/fw876/helloworld.git;main" >> "feeds.conf.different"
echo "src-git passwall_packages https://github.com/xiaorouji/openwrt-passwall-packages.git;main" >> "feeds.conf.different"
